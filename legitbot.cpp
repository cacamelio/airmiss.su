...
//	auto weapon_config = main_utils::get_legit_weapon_config();
//
...
//}
//
//bool c_legit_bot::is_target_in_fov(const vec2_t& center, const vec2_t& screen)
//{
...
//}
//
//__forceinline void smooth_angles(vec3_t MyViewAngles, vec3_t AimAngles, vec3_t& OutAngles, float Smoothing)
//{
...
//}
//
//int c_legit_bot::get_min_damage(c_cs_player* player)
//{
...
//}
//
//bool c_legit_bot::is_visible(c_cs_player* player, const vec3_t& pos)
//{
...
//}
//
//bool line_goes_through_smoke(const vec3_t& start, const vec3_t& end)
//{
//	return func_ptrs::line_goes_through_smoke(start, end);
//}
//
//float calc_fov_value(const vec3_t& view_angles, const vec3_t& start, const vec3_t& end)
//{
//	vec3_t dir, fw;
//
...
//	}
//
//	auto nearest_target = ANTI_AIM->get_closest_player();
//	if (!nearest_target)
//	{
//		last_time = 0.f;
//		return;
...
//	vec3_t nearest_hitbox{};
//	vec2_t center = vec2_t(g_render->screen_size.w * 0.5f, g_render->screen_size.h * 0.5f);
...
//	{
//		auto records = ANIMFIX->get_all_records(nearest_target);
//		if (records.empty())
//		{
//			last_time = 0.f;
//			return;
